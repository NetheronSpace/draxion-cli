...
translations = {
    'en': {
        ...
        "private_key_saved": "✓ Private key encrypted and saved in {KEY_FILE}",
        ...
        "registration_complete": "✓ Registration process completed.",
        ...
        "zkp_login_successful": "✓ ZKP login successful!",
        ...
        "key_split_successfully": "✓ Key split successfully. Show the following shares and save them securely:",
        "share": "SHARE",
        ...
        "key_recovered_successfully": "✓ Key recovered successfully.",
        ...
        "item_number_prompt": "» Item number for action '{cmd}': ",
        ...
        "manage_shared_files": "👥 Manage Shared Files",
        ...
        "item_id_prompt": "» Item ID for action '{cmd}': ",
        ...
        "file_moved_to_trash": "✓ File moved to trash successfully.",
        "yes_char": "y",
        "delete_word": "DELETE",
    ...
    'es': {
        ...
        "recover_key": "🔑 Recuperar Clave (SSS)",
        ...
        "account_password": "Contraseña de cuenta (para recuperación)",
        "confirm_account_password": "Confirme contraseña de cuenta",
        "passwords_do_not_match": "Las contraseñas no coinciden",
        "password_length_error": "La contraseña debe tener al menos 8 caracteres",
        "account_pin": "PIN de cuenta (4 dígitos, para recuperación)",
        "confirm_pin": "Confirme PIN",
        "pins_do_not_match": "Los PINs no coinciden",
        "pin_length_error": "PIN debe ser de 4 dígitos",
        "registration_error": "Error en registro",
        "account_registration_successful": "✓ Registro de cuenta exitoso!",
        "private_key_password_title": "REGISTRO - CONTRASEÑA DE CLAVE PRIVADA",
        "private_key_password_info1": "Esta contraseña cifra su clave privada y será su credencial principal.",
        "private_key_password_info2": "Es la única forma de acceder a sus archivos. ¡No la olvide!",
        "key_password": "Contraseña para la clave (su nueva 'master password')",
        "confirm_key_password": "Confirme contraseña para la clave",
        "key_password_length_error": "La contraseña para la clave debe tener al menos 12 caracteres",
        "private_key_saved": "✓ Clave privada cifrada y guardada en {KEY_FILE}",
        ...
        "zkp_account_error": "Su cuenta podría no funcionar. Contacte a soporte.",
        "zkp_generation_error": "Error generando la firma ZKP: {e}",
        "registration_complete": "✓ Proceso de registro completado.",
        "login_title": "INICIO DE SESIÓN (ZKP)",
        "logging_in": "Iniciando sesión con el servidor...",
        ...
        "zkp_login_successful": "✓ Inicio de sesión ZKP exitoso!",
        "key_load_error": "Error: La contraseña de la clave es correcta (login ZKP exitoso), pero no se pudo cargar el archivo {KEY_FILE}.",
        "welcome_banner": "BIENVENIDO, {username}",
        "operations_menu": "Menú de Operaciones",
        "file_management": "📁 Gestión de Archivos",
        "upload_files": "📤 Subir Archivos",
        "key_rotation": "🔄 Rotación de Claves",
        "audit_log": "📝 Registro de Auditoría",
        "split_key": "🔑 Dividir Clave (SSS)",
        ...
        "logging_out_message": "Cerrando sesión...",
        "exiting": "Saliendo del sistema",
        "session_refreshed": "Sesión refrescada exitosamente.",
        "connection_error": "Error de conexión",
        "token_expired": "Token expirado, intentando refrescar...",
        "retry_connection_error": "Error de conexión en reintento",
        "session_refresh_failed": "No se pudo refrescar la sesión. Por favor, inicie sesión de nuevo.",
        "private_key_not_found": "Archivo de clave privada no encontrado",
        "private_key_decryption_error": "Error: No se pudo descifrar la clave privada. La contraseña podría ser incorrecta.",
        "error_loading_private_key": "Error cargando clave privada",
        "error_saving_key": "Error guardando o cifrando clave",
        "tkinter_not_available": "Error: Tkinter no está disponible para la selección gráfica.",
        ...
        "must_be_logged_in_to_split_key": "Error: Debes iniciar sesión y tener una clave privada cargada para poder dividirla.",
        "split_key_title": "DIVIDIR CLAVE (SHAMIR'S SECRET SHARING)",
        "split_key_info1": "Esta herramienta dividirá tu clave privada en varios fragmentos (shares).",
        "split_key_info2": "Para recuperar la clave, necesitarás un número mínimo de estos fragmentos.",
        "split_key_warning": "¡Guarda cada fragmento en un lugar seguro y separado!",
        "total_shares_prompt": "Número total de fragmentos a crear (ej. 5)",
        "required_shares_prompt": "Número mínimo de fragmentos para recuperar (ej. 3)",
        "k_greater_than_n_error": "Error: El número mínimo de fragmentos no puede ser mayor que el total.",
        "invalid_number_error": "Error: Introduce solo números enteros.",
        "generating_n_shares": "Generando {n} fragmentos",
        "error_splitting_key": "Error al dividir la clave",
        "key_split_successfully": "✓ Clave dividida exitosamente. Muestra los siguientes fragmentos y guárdalos de forma segura:",
        "share": "Compartir",
        "share_accepted": "Fragmento aceptado.",
        "save_shares_prompt": "Asegúrate de haber guardado todos los fragmentos antes de salir.",
        "press_enter_to_return": "Presione Enter para volver al menú",
        ...
        "enter_shares_prompt": "Introduce los fragmentos de tu clave uno por uno. \nDeja una línea en blanco para finalizar.",
        "recovering_key_with_n_shares": "Intentando recuperar la clave con {n} fragmentos",
        "reconstructing_key": "Reconstruyendo clave...",
        "error_recovering_key": "Error al recuperar la clave. Asegúrate de que los fragmentos son correctos.",
        "key_recovered_successfully": "✓ Clave recuperada exitosamente.",
        "create_new_password_for_key": "Ahora, crea una nueva contraseña para cifrar este archivo de clave en tu disco.",
        "new_key_password": "Nueva contraseña para la clave",
        "confirm_new_key_password": "Confirme la nueva contraseña",
        "new_private_key_saved": "Nueva clave privada cifrada y guardada en {KEY_FILE}.",
        "you_can_login_now": "Puedes iniciar sesión normalmente ahora.",
        "critical_error_saving_key": "ERROR CRÍTICO: No se pudo guardar la clave recuperada.",
        ...
        "sss_recovery_info": "La recuperación SSS es para cuando has perdido este archivo.",
        "upload_file_title": "SUBIR ARCHIVO (CON REANUDACIÓN)",
        "selection_method": "Método de Selección",
        "graphical_window": "Ventana Gráfica",
        ...
        "found_previous_upload": "Se encontró una subida previa (ID: {upload_id})",
        ...
        "you_can_resume_later": "Puede reanudarla más tarde",
        ...
        "download_file_title": "DESCARGAR ARCHIVO (CON REANUDACIÓN)",
        "file": "Archivo",
        "save_path_prompt": "Ruta para guardar (dejar vacío para nombre original)",
        ...
        "key_rotation_warning": "ADVERTENCIA: Esta operación es crítica. Asegúrate de guardar la nueva clave privada.",
        "cached_password_not_found": "Error: No se encontró la contraseña de la clave en caché. Intente reiniciar sesión.",
        "rotating_security_keys": "Rotando claves de seguridad",
        "keys_rotated_successfully": "Claves rotadas exitosamente",
        "new_public_key_saved_on_server": "Nueva clave pública guardada en servidor",
        ...
        "error_getting_audit_log": "Error al obtener auditoría",
        "no_audit_events": "No hay eventos de auditoría para mostrar.",
        "page": "Página",
        "press_enter_for_next_page": "Presione Enter para ver la página siguiente, o escriba 's' para salir",
        "end_of_audit_log": "Fin del registro de auditoría.",
        "only_owner_can_delete": "Solo el propietario puede eliminar el archivo",
        "delete_file_title": "ELIMINAR ARCHIVO",
        "are_you_sure_you_want_to_delete": "¿Estás seguro de eliminar '{file}'",
        ...
        "file_management_title": "GESTIÓN DE ARCHIVOS",
        "no_files_available": "No hay archivos disponibles.",
        "download_file": "Descargar archivo",
        "delete_file": "Eliminar archivo",
        "share_file": "Compartir archivo",
        "select_file_number": "Seleccione el número de archivo",
        "invalid_file_number": "Número de archivo inválido",
        "invalid_input": "Entrada inválida",
        "thank_you_for_using": "Gracias por usar Draxion Cloud",
        "session_closed_due_to_error": "Sesión cerrada por un error de conexión.",
        "table_header_no": "No.",
        "table_header_file": "ARCHIVO",
        "table_header_size": "TAMAÑO",
        "table_header_date": "FECHA",
        "pending_shares": "📬 Archivos Pendientes",
        ...
        "file_name": "Archivo",
        "date": "Fecha",
        "accept_reject_prompt": "Seleccione una invitación para (A)ceptar o (R)echazar (ej. A 1), o 0 para volver",
        "username_cannot_be_empty": "El nombre de usuario no puede estar vacío",
        ...
        "item_renamed_successfully": "✓ Elemento renombrado con éxito",
        "item_moved_successfully": "✓ Elemento movido con éxito",
        "folder_deleted_successfully": "✓ Carpeta eliminada con éxito",
        ...
        "folder_not_empty": "La carpeta no está vacía y no se puede eliminar",
        "select_item_or_option": "Selecciona un número de elemento para gestionar, o una opción",
        "open": "Abrir",
        "move": "Mover",
        "rename": "Renombrar",
        "delete": "Eliminar",
        ...
        "enter_item_number_to_open": "Introduce el número del elemento para abrir",
        "enter_item_number_to_rename": "Introduce el número del elemento para renombrar",
        "enter_item_number_to_move": "Introduce el número del elemento para mover",
        "enter_item_number_to_delete": "Introduce el número del elemento para eliminar",
        "enter_item_number_to_share": "Introduce el número del elemento para compartir",
        "cannot_share_folder": "Solo puedes compartir archivos.",
        "are_you_sure_delete_folder": "¿Estás seguro de que quieres eliminar la carpeta '{folder_name}'? (s/n): ",
        "plan": "Plan",
        "usage": "Uso",
        "of": "de",
        "unlimited": "Ilimitado",
        "no_active_plan": "Lo sentimos, pero debe seleccionar algún plan para continuar.",
        ...
        "root_folder_option": "0. / (Raíz)",
        "parent_folder_option": ".. (Directorio Superior)",
        "item_number_prompt": "» Número de elemento para la acción '{cmd}': ",
        ...
        "manage_accounts_menu": "Menú de Cuentas",
        "add_account": "Añadir Nueva Cuenta",
        "switch_account": "Cambiar de Cuenta",
        "logout_from_account": "Cerrar Sesión de Cuenta",
        "no_profiles_found": "No se encontraron perfiles. Por favor, añada una cuenta.",
        "select_profile_to_switch": "Seleccione un perfil al que cambiar",
        "select_profile_to_logout": "Seleccione un perfil del que cerrar sesión",
        "profile_switched": "Cambiado al perfil: {username}",
        "profile_logged_out": "Sesión cerrada del perfil: {username}",
        "reload": "Recargar",
        ...
        "manage_shared_files": "👥 Gestionar Archivos Compartidos",
        "shared_files_title": "Mis Archivos Compartidos",
        "no_shared_files": "No has compartido ningún archivo.",
        ...
        "no_users_with_access": "Ningún otro usuario tiene acceso a este archivo.",
        "select_user_to_revoke": "Selecciona un usuario para revocar el acceso",
        "revoke_access_confirm": "¿Estás seguro de que quieres revocar el acceso de {username} a {file_name}?",
        ...
        "confirm_remove_share_access": "¿Quitar '{file_name}' de tu vista? (s/n): ",
        ...
        "item_id_prompt": "» ID del elemento para la acción '{cmd}': ",
        "invalid_file_id": "ID de archivo inválido",
        "restoring_file": "Restaurando archivo...",
        "file_restored_successfully": "Archivo restaurado con éxito",
        "error_restoring_file": "Error al restaurar el archivo",
        "are_you_sure_delete_permanently": "¿Estás seguro de eliminar permanentemente este archivo? (s/n): ",
        ...
        "delete_options_title": "OPCIONES DE ELIMINACIÓN",
        "move_to_trash": "Mover a la Papelera (Por defecto)",
        "delete_permanently": "Eliminar Permanentemente (Irreversible)",
        "select_delete_option": "Seleccione una opción",
        "are_you_sure_delete_permanently_confirm": "Esta acción es IRREVERSIBLE. Escriba la palabra 'ELIMINAR' para confirmar: ",
        "file_moved_to_trash": "✓ Archivo movido a la papelera con éxito.",
        "yes_char": "s",
        "delete_word": "ELIMINAR",
        "upload_file": "Subir un solo archivo",
        "upload_folder": "Subir una carpeta completa",
        "from_cache": "desde caché",
        "loading_from_server": "Cargando desde el servidor (caché ausente o expirado)",
        ...
        "invalid_directory_selected": "Directorio seleccionado no válido.",
        "starting_download_of_n_files": "Iniciando descarga de {n} archivos",
        "using_n_threads": "usando {n} hilos",
        "file_downloaded_successfully": "Archivo '{file}' descargado con éxito",
        "file_download_failed": "La descarga del archivo '{file}' falló",
        "file_download_generated_exception": "La descarga de '{file}' generó una excepción: {exc}",
        ...
        "file_uploaded_successfully": "Archivo '{file}' subido con éxito",
        "file_upload_failed": "La subida del archivo '{file}' falló",
        "file_upload_generated_exception": "La subida de '{file}' generó una excepción: {exc}",
        ...
        "invalid_path": "La ruta seleccionada no es válida o no existe.",
        ...
        "are_you_sure_delete_file": "¿Estás seguro de que quieres eliminar '{file_name}'?",
...
def set_language(lang):
    """
    Establece el idioma actual para la sesión y lo guarda en la configuración.
    """
